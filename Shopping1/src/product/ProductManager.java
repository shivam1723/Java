...
public class ProductManager {
    ...
    public void addProduct(Product product) {
        if (productList.containsKey(product.getProductId())) {
            ...
            switch (choice) {
                case 1:  // Replace the entire product
                    replaceProduct(existingProduct.getProductId());
                    break;
                case 2:  // Add more stock to the existing product
            ...
            // Add a new product if productId is not already present
    ...
    private void replaceProduct(int productId) {
        ...
        // Create a new product object and replace the existing one
